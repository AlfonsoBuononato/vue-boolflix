<template>
  <main>
    <div class="title">
      <h2>TITOLI DEL MOMENTO</h2>
    </div>
    <div class="container">
      <div class="box" v-for="(element, index) in trand" :key="index">
        ...
        <ul>
          ...
          <li>
            ...
            />
            <img
              v-if="element.original_language === 'en'"
              src="../assets/en.png"
              alt=""
            />
            <span
